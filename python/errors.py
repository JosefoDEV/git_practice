# There are three different types of errors in python:
...
# Example: 'Misspeling variable', 'forgeting to define a variable'

# 3. TypeError: when operation is applied to an object of an incorrect type
# Example:
number = 4 + '1'
